    ...
    <View className="flex-1 justify-between px-5 py-10 bg-gray-50">
      ...
      <View>
        ...
        <View className="space-y-5">
          ...
          >
            <Text className="text-white text-center text-lg font-semibold" style={styles.poppinsRegular}>Register</Text>
          </Pressable>
      ...
      <View className="mb-5">
        <Text className="text-sm text-gray-600 text-center " style={styles.poppinsRegular}>
          ...
          <Pressable onPress={() => router.replace("/(auth)/login")}>
            <Text className="text-[#890620] font-semibold">Login</Text>
          </Pressable>
        </Text>
      </View>
    </View>
