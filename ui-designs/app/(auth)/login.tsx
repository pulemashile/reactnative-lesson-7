...
const Login = () => {
  ...
  return (
    <View className="flex-1 justify-between px-5 py-10 bg-gray-50">
       <Text className="text-3xl font-bold text-center text-black mb-4" style={styles.poppinsRegular}>Sign in</Text>
      <View>
       
        <Text className="text-sm text-center text-gray-600 mb-8" style={styles.poppinsRegular}>Sign in to your account to get access to various features</Text>
        ...
        <View className="space-y-5">
          ...
          {/* Login Button */}
          <Pressable
            className="bg-[#890620] rounded-full h-[3rem] w-full pt-2 mt-10 align-self-center"
          ...
          <View className="flex-row items-center justify-center mt-8 mb-4">
            ...
            <Text className="mx-4 text-sm text-gray-600" style={styles.poppinsRegular}>Login with</Text>
            <View style={{ flex: 1, borderBottomWidth: 1, borderColor: '#ccc' }} />
          </View>
          ...
          <View className="flex-row justify-between space-x-4">
            ...
            >
              ...
              />
              <Text className="text-gray-600 text-center" style={styles.poppinsRegular}>Facebook</Text>  
            </Pressable>
            <Pressable
              style={{
                flex: 1,
            ...
            >
              ...
              />
              <Text className="text-gray-600 text-center" style={styles.poppinsRegular}>Google</Text>
            </Pressable>
          </View>
        </View>
      </View>
      ...
      <View className="mb-5">
        <Text className="text-sm text-gray-600 text-center " style={styles.poppinsRegular}>
          ...
          <Pressable onPress={() => { router.push('/(auth)/register') }}>
            <Text className="font-medium text-blue-300 text-arial" style={styles.poppinsSemiBold}>Sign up here</Text>
          </Pressable>
        </Text>
      </View>
    </View>
